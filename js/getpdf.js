		...
		$.ajax({ 
			...
			success: function(msg){ 
				...
				if(pdfs.signature=="null"){	
					...
					$("#displayarea").append("<div id=\"message\" class=\"alert alert-info\"><p>Aucune signature enregistr�e. " +
...
//Fonction appel�e lorsque l'on clique sur le bouton "Effacer"
...
function sendSignature(){
	...
	$.ajax({ 
		...
		success: function(msg){ // si l'appel a bien fonctionn�
			if(msg=="error") {
				alert('La signature n a pas �t� enregistr�e');
				return false;
			}
			else{
